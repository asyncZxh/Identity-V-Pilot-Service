...
function renderNoteList() {
  let noteContent = "";
  function renderTier(tier, nextTier, subtier) {
    {
      for (let s = subtier; s >= 1; s--) {
        if (s === 1) {
          noteContent += `<li>${tier} ${s} - 5 <svg
  ...
  renderTier("Bee", "Hound", 3);
  renderTier("Hound", "Elk", 4);
  renderTier("Elk", "Mammoth", 5);
  renderTier("Mammoth", "Griffin", 5);
  renderTier("Griffin", "Alicorn", 5);
  renderTier("Alicorn", "Champion", 5);

  //render tier(hunter)
  renderTier("Spider", "Cobra", 3);
  renderTier("Cobra", "Crocodile", 4);
  renderTier("Crocodile", "Sabertooth", 5);
  renderTier("Sabertooth", "Manticore", 5);
  renderTier("Manticore", "Cyclops", 5);
  renderTier("Cyclops", "Evil Dragon", 5);
