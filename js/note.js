...
function renderNoteList() {
  ...
  renderTier3To7("Elk", "Mammoth");
  renderTier3To7("Mammoth", "Griffin");
  renderTier3To7("Griffin", "Alicorn");
  renderTier3To7("Alicorn", "Champion");
  ...
  function renderTier3To7(tier, nextTier) {
    {
      for (let s = 5; s >= 1; s--) {
        if (s === 1) {
